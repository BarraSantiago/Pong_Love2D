...
local font = love.graphics.newFont("insane_hours_2.ttf", 18)
...
function love.draw()
  ...
  love.graphics.print(pauseText, love.graphics.getWidth() / 100, love.graphics.getHeight() * 0.94)
  love.graphics.print("Mantener espacio = slow motion", love.graphics.getWidth() / 1.6, love.graphics.getHeight() * 0.94)
